...
@section('title', 'AIA H&S PLUS GOLD | สัญญาเพิ่มเติมกลุ่มค่ารักษาพยาบาล')

@section('facebook-meta')
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="สัญญาเพิ่มเติมเอไอเอ เอช แอนด์ เอส พลัส โกลด์" />
...
@section('content')
    ...
    <div class="title-container">
        <h3 class="topic">H&S PLUS GOLD</h3>
        <h5>สัญญาเพิ่มเติมเอไอเอ เอช แอนด์ เอส พลัส โกลด์</h5>
    ...
    <div>
        <img src="{{ asset("components/image/HS/Manual_Rider-06.png") }}" >
        <img src="{{ asset("components/image/HS/Manual_Rider-07.png") }}" >
    </div>
